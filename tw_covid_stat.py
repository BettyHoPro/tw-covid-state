...
#######################################
daily_tested = np.array( [6534.,8459.,15617.,18178.,17867.,18099.,21875.,14568.,12911.] ) #https://data.gov.tw/dataset/120451
daily_reported_positive = np.array( [180.,269.,476.,382.,431.,405.,385.,380.,344] )
