...
#######################################
daily_tested = np.array( [6534.,8459.,15617.,18178.,17867.,18099.,21875.,14568.,12911.,23608., 25005., 21634.] ) #https://od.cdc.gov.tw/eic/covid19/covid19_tw_stats.csv May 26 送驗 
daily_reported_positive = np.array( [185.,276.,530.,447.,518.,467.,418.,451.,454.,464., 427., 395., 401 ] ) #MAY 27 correction
