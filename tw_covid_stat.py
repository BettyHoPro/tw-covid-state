...
#######################################
daily_tested = np.array( [6534.,8459.,15617.,18178.,17867.,18099.,21875.,14568.,12911.,23608.] ) #https://data.gov.tw/dataset/120451 昨日送驗
daily_reported_positive = np.array( [180.,269.,476.,382.,431.,405.,385.,380.,344.,595. ] ) 
daily_reported_positive_rate = np.array( [5.8,4.4,2.6,2.2,2.1,2.7,2.8,3.4,3.4, ] )*0.01
