...
#######################################
daily_tested = np.array( [6534.,8459.,15617.,18178.,17867.,18099.,21875.,14568.,12911.,23608.] ) #https://data.gov.tw/dataset/120451 May 24 送驗 
# daily_reported_positive = np.array( [180.,269.,476.,382.,431.,405.,385.,380.,344.,595. ] ) 
daily_reported_positive = np.array( [185.,276.,510.,414.,468.,435.,402.,402.,384.,376., 281. ] ) #MAY 24 already fix, May 25 not yet correct but include
daily_reported_positive_rate = np.array( [5.8,4.4,2.6,2.2,2.1,2.7,2.8,3.4,3.4, ] )*0.01 #May 24 not update yet.
